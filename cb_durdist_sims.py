...
taus1 = np.arange(.2, 2.02, .1)
taus2 = np.arange(2.1, 4, .25)
taus3 = np.arange(4, 10, 1)
taus4 = np.arange(10, 41, 2)
...
for i, data in enumerate(datas):
    ...
    for k in range(num_networks):
        ...
        with open(f'duration+ages/seir_sims/{data}_{k+140}_gen1.json','w') as f:
            json.dump(res, f)