...
taus1 = np.arange(.01, 2.01, .05)
taus2 = np.arange(2.1, 4, .1)
taus3 = np.arange(4, 10, .5)
taus4 = np.arange(10, 31, 1)
...
for i, data in enumerate(datas):
    ...
    for k in range(num_networks):
        ...
        with open(f'duration+ages/seir_sims/{data}_{k+100}_gen1.json','w') as f:
            json.dump(res, f)