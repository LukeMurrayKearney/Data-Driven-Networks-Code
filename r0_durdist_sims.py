...
for i, data in enumerate(datas):
    ...
    for k in range(num_networks):
        ...
        res = nd_p.gmm_dur_r0(samples,partitions=partitions,num_dur=3, taus=taus, iterations=48)
        with open(f'duration+ages/r0s/{data}_{k}.json','w') as f:
            json.dump(res, f)